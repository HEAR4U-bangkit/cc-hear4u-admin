...
import { useDeleteArticle, useGetAllArticles } from "@/hooks/useArticle";
...
export default function Articles() {
  ...
  const formattedDate = data?.data?.data.map((article) => ({
    ...article,
    content: limitString(article.content),
  ...
  const actions = (article) => (
    <>
      <TableAction
        ...
        action={() => push(`/articles/${article.id}`)}
      />
      <TableAction
        icon={
          <svg
